...
ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_game_opp FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_game_winner FOREIGN KEY (winner_id) REFERENCES public.teams(team_id) ON DELETE CASCADE;
